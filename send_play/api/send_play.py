...
class ModuleResultsCollector():
    ...
    def passed(self, IDOPeration, status):
    ...
    def failed(self, IDOPeration, status):
    ...
    def running(self, IDOPeration, user, frequency, playbook, customer, host):
        ...
        try:
            ...
            print("Started      *****************************************************")
            flow.run_playbook(host, hosts_path, play_path+playbook, user)

        except:

            flow = ModuleResultsCollector()
            flow.failed(IDOPeration, 'FAILED')

    def run_playbook(self, affected_host, host_file, playbook_path, selectuser):
            ...
            try:
                ...
                try:
                    ...
                    if(check[affected_host] == 2):
                        ...
                        flow = ModuleResultsCollector()
                        flow.passed(IDOPeration, 'PASSED')
